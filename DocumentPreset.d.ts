...
declare class DocumentPreset
{
	...
	/**
	 * The number of rows (for rows layout) or columns (for column layout) of artboards. Range: 1 to ({@link numArtboards} - 1) or 1 for single row or column layouts. Default: 1
	 * @type {Number} long
	 * @see {@link DocumentPreset}
	 * @since CS4
	 * @version CS4
