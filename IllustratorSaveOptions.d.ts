...
{
	/**
	 * If {@link saveMultipleArtboards} is <b>true</b> (which is valid only for Illustrator 13 or earlier), the document is considered for multi-asset extraction, which specifies an artboard range. An empty string extracts all artboards. Default: <b>empty string</b>
	 * @type {String}
	...
	/**
	 * Specifies the version of Illustrator file format to create. Default: {@link Compatibility.ILLUSTRATOR17}
	 * @type {Compatibility}
	 * @see {@link IllustratorSaveOptions}
	 * @since CS2
	 * @version CC
	...
	/**
	 * (Illustrator version 9 or later.) Include a subset of fonts when less than this percentage of characters is used in the document. Range: <b>0.0 to 100.0</b>. Default: <b>100.0</b>
	 * @type {Number} double
	 * @see {@link IllustratorSaveOptions}
	 * @since CS2
	 * @version CS2
