...
declare class CharacterAttributes
{
	...
	/**
	 * The character horizontal scaling factor expressed as a percentage (<b>100 = 100%</b>).
	 * @type {Number} double
	 * @see {@link CharacterAttributes}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * If <b>true</b>, line breaks are not allowed.
	 * @type {Boolean}
	 * @see {@link CharacterAttributes}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * Character vertical scaling factor expressed as a percentage (<b>100 = 100%</b>).
	 * @type {Number} double
	 * @see {@link CharacterAttributes}
	 * @since CS2
	 * @version CS2
