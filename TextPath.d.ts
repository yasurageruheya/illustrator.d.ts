...
declare class TextPath
{
	...
	/**
	 * The position (in points) of the top left corner of the {@link TextPath} object in the format [x, y]. Does not include stroke weight.
	...
	/**
	 * When a default stroke join is set to {@link StrokeJoin.MITERENDJOIN}, this property specifies when the join will be converted to beveled (squared-off ) by default. The default miter limit of 4 means that when the length of the point reaches four times the stroke weight, the join switches from a miter join to a bevel join. A value of 1 specifies a bevel join. Range: 1 to 500 Default: 4
	 * @type {Number} double
	 * @see {@link TextPath}
	 * @since CS2
	 * @version CS2
