...
declare class ExportOptionsGIF extends ExportOptions
{
	...
	/**
	 * The number of colors in the exported image’s color table. Range: <b>2 to 256</b>. Default: <b>128</b>
	 * @type {Number} long
	 * @see {@link ExportOptionsGIF}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * How much should the colors of the exported image be dithered, where <b>100.0 is 100%</b>.
	 * @type {Number} long
	 * @see {@link ExportOptionsGIF}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The level of information loss allowed during compression, where <b>100.0 is 100%</b>.
	 * @type {Number} long
	 * @see {@link ExportOptionsGIF}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The vertical scaling factor to apply to the exported image, where <b>100.0 is 100%</b>. Default: <b>100.0</b>
	 * @type {Number} double
	 * @see {@link ExportOptionsGIF}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * How much should the color table be changed to match the web palette, where 100 is maximum. Default: <b>0</b>
	 * @type {Number} long
	 * @see {@link ExportOptionsGIF}
	 * @since CS2
	 * @version CS2
