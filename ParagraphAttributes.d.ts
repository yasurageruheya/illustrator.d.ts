...
declare class ParagraphAttributes
{
	...
	/**
	 * Desired glyph scaling, expressed as a percentage of the default character width. Range: <b>50.0 to 200.0</b>. At <b>100.0,</b> the width of characters is not changed.
	 * @type {Number} double
	 * @see {@link ParagraphAttributes}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * Desired word spacing, expressed as a percentage of the default space for the font. Range: <b>0.0 to 1000.0</b>; at <b>100.00</b> No space is added between words.
	 * @type {Number} double
	 * @see {@link ParagraphAttributes}
	 * @since CS2
	 * @version CS2
