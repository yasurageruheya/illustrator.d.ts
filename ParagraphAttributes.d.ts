...
declare class ParagraphAttributes
{
	...
	/**
	 * The distance (in points) from the right edge of the paragraph that marks the part of the line where hyphenation is not allowed. Note: 0 allows all hyphenation. Valid only when {@link ParagraphAttributes#everyLineComposer} is <b>false</b>.
	 * @type {Number} double
	 * @see {@link ParagraphAttributes}
	 * @since CS2
	 * @version CS2
	 ...
	 * Range: 50.0 to 200.0; at 100.0, the width of characters is not changed. Note: Valid only for justified paragraphs.
	 * @type {Number} double
	 * @see {@link ParagraphAttributes}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * Maximum letter spacing, expressed as a percentage of the default kerning or tracking Range: -100.0 to 500.0; at 0, no space is added between letters; at 100.0, an entire space width is added between letters. Note: Valid only for justified paragraphs.
	 * @type {Number} double
	 * @see {@link ParagraphAttributes}
	 * @since CS2
	 * @version CS2
	 ...
	 * Range: 0.0 to 1000.0; at 100.00, no space is added between words.Note: Valid only for justified paragraphs.
	 * @type {Number} double
	 * @see {@link ParagraphAttributes}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * Minimum letter spacing, expressed as a percentage of the default kerning or tracking Range: -100.0 to 500.0; at 0, no space is added between letters; at 100.0, an entire space width is added between letters. Note: Valid only for justified paragraphs.
	 * @type {Number} double
	 * @see {@link ParagraphAttributes}
	 * @since CS2
	 * @version CS2
