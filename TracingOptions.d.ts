...
declare class TracingOptions
{
	...
	/**
	 * Saves this set of options in the specified preset. Use a name found in the {@link Application#tracingPresetList} array, or a new name to create a new preset. For an existing preset, overwrites an unlocked preset and returns <b>true</b>. Returns <b>false</b> if the preset is locked.
	 * @param {String} presetName {@link String}
	 * @return {Boolean} {@link Boolean}
	 * @see {@link TracingOptions}
	 * @since CS2
