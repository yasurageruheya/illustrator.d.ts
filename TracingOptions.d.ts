...
declare class TracingOptions
{
	...
	/**
	 * If <b>true</b>, trace with fills. At least one of {@link TracingOptions#fills} or {@link TracingOptions#strokes} must be <b>true</b>.
	 * @type {Boolean}
	 * @see {@link TracingOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The maximum number of colors allowed for automatic palette generation. Used only if {@link TracingOptions#tracingMode} is color or grayscale. Range: 2 to 256
	 * @type {Number} long
	 * @see {@link TracingOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The maximum stroke weight, when {@link TracingOptions#strokes} is <b>true</b>. Range: 0.01 to 100.0
	 * @type {Number} double
	 * @see {@link TracingOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The minimum length in pixels of features in the original image that can be stroked, when {@link TracingOptions#strokes} is <b>true</b>. Smaller features are omitted. Range: 0.0 to 200.0 Default: 20.0
	 * @type {Number} double
	 * @see {@link TracingOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * If <b>true</b>, trace with strokes. At least one of {@link TracingOptions#fills} or {@link TracingOptions#strokes} must be <b>true</b>. Used only if {@link TracingOptions#tracingMode} is black-and-white.
	 * @type {Boolean}
	 * @see {@link TracingOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The threshold value of black-and-white tracing. All pixels with a grayscale value greater than this are converted to black. Used only if {@link TracingOptions#tracingMode} is black-and-white. Range: 0 to 255
	 * @type {Number} long
	 * @see {@link TracingOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * Loads a set of options from the specified preset, as found in the {@link Application#tracingPresetList} array.
	...
	/**
	 * Saves this set of options in the specified preset. Use a name found in the
	 * {@link Application#tracingPresetList} array, or a new name to create a new preset. For an existing preset, overwrites an unlocked preset and returns <b>true</b>. Returns <b>false</b> if the preset is locked.
	 * @param {String} presetName {@link String}
	 * @return {Boolean} {@link Boolean}
	 * @see {@link TracingOptions}
	 * @since CS2
