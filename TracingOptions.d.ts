...
declare class TracingOptions
{
	...
	/**
	 * The maximum stroke weight, when {@link strokes} is <b>true</b>. Range: 0.01 to 100.0
	 * @type {Number} double
	 * @see {@link TracingOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The minimum length in pixels of features in the original image that can be stroked, when {@link strokes} is <b>true</b>. Smaller features are omitted. Range: 0.0 to 200.0 Default: 20.0
	 * @type {Number} double
	 * @see {@link TracingOptions}
	 * @since CS2
	 * @version CS2
