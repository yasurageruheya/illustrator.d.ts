 ...
 * A variable is a dynamic object used to create data-driven graphics. For an example, see {@link Dataset}. {@link Variables} are accessed in Illustrator through the {@link Variables} palette.
 *
 * @since CS2
 * @version CS2
 *
