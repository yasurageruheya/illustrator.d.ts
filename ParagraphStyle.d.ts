/**
 * Associates character and paragraph attributes with a style name. The style object can be used to apply those attributes to the text in a TextFrame object. See <a href="psi_element://ParagraphStyles">Creating and applying a paragraph style</a> below.
 *
 * @since CS2
 * @version CS2
 *
