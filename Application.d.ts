/**
 * The Adobe® Illustrator® application object, referenced using the pre-defined global <a href="psi_element://Application">app</a> object, which contains all other Illustrator objects.
 *
 * @since CS2
 * @version CS4
 *
...
declare class Application
{
	 ...
	 * If you open a pre-Illustrator 9 document that contains both RGB and CMYK colors and {@link Application#documentColorSpace} is supplied, all colors are converted to the specified color space. If the parameter is not supplied, Illustrator opens a dialog so the user can choose the color space.
	 ...
	 * @param {File} fileSpec {@link File} object
	 * @return {String[]} array of {@link String}
	 * @see {@link Application}
	 * @since CS2
	 * @version CS4
	 */
