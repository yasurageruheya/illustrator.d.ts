/**
 * An art item made reusable by adding it to the Symbols palette. A {@link SymbolItem} is linked to the {@link Symbol} from which it was created and changes if you modify the associated {@link Symbol} object.
 *
 * @since CS2
 * @version CS3
 *
...
declare class SymbolItem extends PageItem
{
	...
	/**
	 * The {@link Symbol} that was used to create this {@link SymbolItem}.
