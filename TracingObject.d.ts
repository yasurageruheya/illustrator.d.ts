 ...
 * A script can force the tracing operation by calling the document’s {@link Application#redraw} method. The operation is asynchronous, so a script should call {@link Application#redraw} after creating the tracing object, but before accessing its properties or expanding the tracing to convert it to an art item group.
