...
declare class ExportOptionsJPEG extends ExportOptions
{
	...
	/**
	 * The amount of blur to apply to the exported image. Range: <b>0.0 to 2.0</b>. Default: <b>0.0</b>
	 * @type {Number} double
	 * @see {@link ExportOptionsJPEG}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The quality of the exported image. Range: <b>0 to 100</b>. Default: <b>30</b>
	 * @type {Number} long
	 * @see {@link ExportOptionsJPEG}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The vertical scaling factor to apply to the exported image. Range: <b>0.0 to 776.19</b>. Default: <b>100.0</b>
	 * @type {Number} double
	 * @see {@link ExportOptionsJPEG}
	 * @since CS2
	 * @version CS2
