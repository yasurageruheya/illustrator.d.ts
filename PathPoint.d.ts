/**
 * A point on a specific path. Each path point is made up of an {@link anchor} point ({@link anchor}) and a pair of handles ({@link leftDirection} and {@link rightDirection}).
 *
 * @since CS2
 * @version CS2
 *
...
{
	/**
	 * The position of this point’s {@link anchor} point.
