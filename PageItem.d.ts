...
declare class PageItem
{
	 ...
	 * @const
	 * @type {Number[]} Rect. array of 4 numbers
	 * @see {@link PageItem}
	 * @since CS4
	 * @version CS4
	 */
	 ...
	 * @type {Number[]} Point. array of 2 numbers
	 * @see {@link PageItem}
	 * @since CS4
	 * @version CS4
	 */
	 ...
	 * @param {Number} posX {@link Number}
	 * @param {Number} posY {@link Number}
	 * @param {PerspectiveGridPlaneType} perspectiveGridPlane {@link PerspectiveGridPlaneType}
	 * @see {@link PageItem}
	 * @since CS5
	 * @version CS5
	 */
