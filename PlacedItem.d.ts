...
declare class PlacedItem extends PageItem
{
	...
	/**
	 * Converts the raster art for this object to vector art, using default options. Reorders the placed art into the source art of a plugin group, and converts it into a group of filled and/or stroked paths that resemble the original image.
