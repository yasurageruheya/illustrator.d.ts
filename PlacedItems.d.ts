...
declare class PlacedItems
{
	...
	/**
	 * Creates a new object. Use to place new art in a document, and use the resulting {@link PlacedItem} object’s {@link PlacedItem#embed} method to convert that art to embedded art items.
