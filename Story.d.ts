 ...
 *     // Create two TextFrames and link the 2nd
 *     // to the first to create a single story.
 *     //
 *     // Create a 3rd non-linked TextFrame to create a 2nd story.
 *
 ...
 *     redraw();
 *     alert("There is " + docRef.stories.length + " story");
 *
 ...
 *     textRef3.left = 200;
 *     redraw();
 *     alert("Now there are " + docRef.stories.length + " stories");
 */
declare class Story
{
	/**
