 ...
 * {@link PatternColor} objects can be used in any property that takes a {@link Color} object, such as {@link fillColor} or strokeColor.
 *
 * @since CS2
 * @version CS2
 *
...
declare class PatternColor extends Color
{
	...
	/**
	 * A reference to the {@link Pattern} object that defines the pattern to use in this color definition.
	...
	/**
	 * The axis around which to reflect, in points. Default: <b>0.0</b>
	 * @type {Number} double
	 * @see {@link PatternColor}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The angle in radians to rotate the prototype pattern before filling. Default: <b>0.0</b>
	 * @type {Number} double
	 * @see {@link PatternColor}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The angle in radians by which to slant the shear. Default: <b>0.0</b>
	 * @type {Number} double
	 * @see {@link PatternColor}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The axis to shear with respect to, in points. Default: <b>0.0</b>
	 * @type {Number} double
	 * @see {@link PatternColor}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The angle in radians to which to translate the unscaled prototype pattern before filling. Default: <b>0.0</b>
	 * @type {Number} double
	 * @see {@link PatternColor}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The distance in points to which to translate the unscaled prototype pattern before filling. Default: <b>0.0</b>
	 * @type {Number} double
	 * @see {@link PatternColor}
	 * @since CS2
	 * @version CS2
