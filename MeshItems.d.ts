 ...
 *    The following script illustrates how to copy mesh items from one document to another. To run this script
 *    you need to have two open documents. One document should contain at least one mesh item, the other
