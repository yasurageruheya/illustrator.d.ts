/**
 * A gradient stop definition that represents a point on a specific gradient defined in the document. Each gradient stop specifies a color change in the containing gradient. See <a href="psi_element://GradientColor">Changing a gradient color</a> for an example.
 *
 * @since CS2
 * @version CS2
 *
