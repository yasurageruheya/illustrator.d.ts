...
declare class PrintFlattenerOptions
{
	...
	/**
	 * If <b>true</b>, convert all {@link strokes} to outlines. Default: <b>false</b>
	 * @type {Boolean}
	 * @see {@link PrintFlattenerOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The flattening balance. Range: <b>0.0 to 100.0</b>. Default: <b>100.0</b>
	 * @type {Number} long
	 * @see {@link PrintFlattenerOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The gradient resolution in dots per inch (dpi). Range: <b>1.0 to 9600.0</b>. Default: <b>300.0</b>
	 * @type {Number} double
	 * @see {@link PrintFlattenerOptions}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * The rasterization resolution in dots per inch (dpi). Range: <b>1.0 to 9600.0</b>. Default: <b>300.0</b>
	 * @type {Number} double
	 * @see {@link PrintFlattenerOptions}
	 * @since CS2
	 * @version CS2
