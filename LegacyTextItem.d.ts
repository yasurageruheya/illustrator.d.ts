/**
 * A text object created in Illustrator CS (version 10) or earlier, which is uneditable until converted. To convert legacy text, see {@link LegacyTextItem#convertToNative}.
...
declare class LegacyTextItem extends PageItem
{
	...
	/**
	 * The position (in points) of the top left corner of the {@link LegacyTextItem} object in the format [x, y]. Does not include stroke weight.
