...
declare class GroupItem extends PageItem
{
	...
	/**
	 * If <b>true</b>, the group is clipped to the clipping mask.
	 * @type {Boolean}
	 * @see {@link GroupItem}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * Read-only. The position of this group object within the stacking order of the group or layer({@link parent}) that contains the group object.
	 * @const
	 * @type {Number} long
	 * @see {@link GroupItem}
	 * @since CS2
