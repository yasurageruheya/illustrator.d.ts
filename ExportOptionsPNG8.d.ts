...
declare class ExportOptionsPNG8 extends ExportOptions
{
	...
	/**
	 * The method used to reduce the number of colors in the exported image. Default: {@link ColorReductionMethod.SELECTION}
	...
	/**
	 * Specifies ow much the colors of the exported image should be dithered, where 100.0 is 100%. Range: 0 to 100 Default: <b>88</b>
	 * @type {Number} long
	 * @see {@link ExportOptionsPNG8}
	 * @since CS2
	 * @version CS2
