 ...
 * Matrices are used in conjunction with the <b>transform</b> method and as a property of a number of objects. A matrix specifies how to transform the geometry of an object. You can generate an original matrix using the {@link Application} object methods {@link Application#getTranslationMatrix}, {@link Application#getScaleMatrix}, or {@link Application#getRotationMatrix}.
 ...
 *     matrices together.
 *       // Apply 2 tranformations to all art in a document using the matrix command.
