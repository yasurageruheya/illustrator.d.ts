...
declare class FreeHandFileOptions
{
	...
	/**
	 * If <b>true</b>, imports only the page specified in the {@link FreeHandFileOptions#pageToOpen} property. Default: <b>true</b>
	 * @type {Boolean}
	 * @see {@link FreeHandFileOptions}
	 * @since CS3
	 * @version CS3
	...
	/**
	 * The number of the page to import when opening a multipage document. Valid only when {@link FreeHandFileOptions#importSinglePage} is <b>true</b>.
	 * @type {Number} long
	 * @see {@link FreeHandFileOptions}
	 * @since CS3
	 * @version CS3
