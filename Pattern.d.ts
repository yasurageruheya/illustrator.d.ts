/**
 * A Illustrator pattern definition contained in a document. Patterns are shown in the Palette, and referenced by {@link PatternColor}s that define their appearance.
 *
 * @since CS2
 * @version CS2
 *
