/**
 * An Illustrator pattern definition contained in a document. Patterns are shown in the Swatches palette. Each pattern is referenced by a {@link PatternColor} object, which defines the pattern’s appearance.
 *
 * @since CS2
 * @version CS2
 *
