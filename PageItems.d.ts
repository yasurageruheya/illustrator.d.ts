 ...
 * {@link SymbolItem}
 * {@link TextFrame}
 * You can reference page items through the {@link PageItems} property in a {@link Document}, {@link Layer}, or Group. When you access an individual item in one of these collections, the reference is a page item of one of a particular type. For example, if you use {@link PageItems} to reference a graph item, the <b>typename</b> value of that object is {@link GraphItem}.
 *
 * @since CS2
 * @version CS2
 *
