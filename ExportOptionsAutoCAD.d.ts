 ...
 * When you export a document, a file extension is appended automatically. You should not include any file extension in the file specification. To override the default AutoCAD export format (DWG), use the {@link ExportOptionsAutoCAD#exportFileFormat} property.
 *
 * @since CS3
 * @version CS3
 *
...
declare class ExportOptionsAutoCAD
{
	...
	/**
	 * Specifies whether to preserve appearance or editability during export. Default: {@link AutoCADExportOption.MaximumEditability}
