/**
 * A label associated with a specific piece of artwork. {@link Tags} allows you to assign an unlimited number of key-value pairs to any page item in a document.
 *
 * @since CS2
 * @version CS2
 *
