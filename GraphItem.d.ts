...
declare class GraphItem extends PageItem
{
	 ...
	 * It is not necessary to set the type of the {@link GraphItem#contentVariable} before binding. Illustrator automatically set the type to {@link VariableKind.GRAPH}.
	...
	/**
	 * The position of the left side of the graph item.
	 * @type {Number}
	 * @see {@link GraphItem}
	 * @since CS2
	 * @version CS2
	 ...
	 * It is not necessary to set the type of the {@link GraphItem#visibilityVariable} before binding. Illustrator automatically set the type to {@link VariableKind.VISIBILITY}.
	 * @type {Variable} {@link Variable} object
	 * @see {@link GraphItem}
	 * @since CS2
	 * @version CS2
