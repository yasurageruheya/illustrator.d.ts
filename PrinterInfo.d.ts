 ...
 *         textRef.contents += "\r\t";
 *
 *         textRef.contents += "PS Level = ";
 *         textRef.contents += printerList[i].printerInf.postScriptLevel;
 *         textRef.contents += "\r\t";
 *
 *         textRef.contents += "Device Resolution = ";
 *         textRef.contents += printerList[i].printerInf.deviceResolution;
 *         textRef.contents += "\r\t";
 *
 *         textRef.contents += "InRIPSeparation Support = ";
 *         textRef.contents += printerList[i].printerInf.inRIPSeparationSupport;
 *         textRef.contents += "\r\r";
 *     }
 *     textRef.top = 600;
 *     textRef.left = 200;
 *     redraw();
