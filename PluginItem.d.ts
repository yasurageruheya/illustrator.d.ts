/**
 * An art item created by an Illustrator plug-in. Scripts can create a plug-in item using {@link PlacedItem#trace} or {@link RasterItem#trace}, and can copy existing plug-in items using the {@link duplicate} method, but cannot create {@link PluginItem} objects directly.
 *
 * @since CS2
 * @version CS2
 *
...
declare class PluginItem extends PageItem
{
	...
	/**
	 * If <b>true</b>, this plug-in group represents a vector art item created by tracing a raster art item. The {@link tracing} property contains the {@link TracingObject} associated with the options used to create it.
	 * @type {Boolean}
	 * @see {@link PluginItem}
	 * @since CS2
	 * @version CS2
	...
	/**
	 * When this plug-in group was created by tracing ({@link PluginItem#isTracing} is <b>true</b>), the {@link TracingObject} associated with the options used to create it.
