/**
 * An art item created by an Illustrator plug-in. Scripts can create a plugin item using {@link PlacedItem#trace} or {@link RasterItem#trace}, and can copy existing plugin items using the {@link PluginItem#duplicate} method, but cannot create {@link PluginItem} objects directly.
 *
 * @since CS2
 * @version CS2
 *
...
declare class PluginItem extends PageItem
{
	...
	/**
	 * The position (in points) of the top left corner of the {@link PluginItem} object in the format [x, y]. Does not include stroke weight.
