/**
 * The collection of {@link Variable} objects in the document. For an example of how to create variables, see <a href="psi_element://Dataset">Using variables and datasets</a>.
 *
 * @since CS2
 * @version CS2
 *
