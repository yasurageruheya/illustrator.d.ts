...
declare class PDFSaveOptions extends SaveOptions
{
	...
	/**
	 * Optional. This is considered for multi-asset extraction, which specifies the artboard range. An empty string extracts all the artboards. Default: <b>empty string</b>
	 * @type {String}
	 * @see {@link PDFSaveOptions}
	 * @since CS4
	 * @version CS4
	...
	/**
	 * Optional. {@link View} PDF after saving. Default: <b>false</b>
	 * @type {Boolean}
	 * @see {@link PDFSaveOptions}
	 * @since CS2
	 * @version CS2
