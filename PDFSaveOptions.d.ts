...
declare class PDFSaveOptions extends SaveOptions
{
	...
	/**
	 * The version of the Acrobat file format to create. Default: {@link PDFCompatibility.ACROBAT5}
	...
	/**
	 * If <b>true</b>, enable plaintext metadata 128-bit. Available only for Acrobat 6. Default: <b>false</b>
	 * @type {Boolean}
	 * @see {@link PDFSaveOptions}
	 * @since CS2
	 * @version CS2
