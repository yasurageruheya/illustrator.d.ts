/**
 * A gradient mesh art item. You cannot create mesh items from a script. However, you can copy an existing mesh item with the {@link MeshItem#duplicate} method, then use the one of the move methods to place the copy at the proper location.
 *
 * @since CS2
 * @version CS2
 *
...
declare class MeshItem extends PageItem
{
	...
	/**
	 * The position (in points) of the top left corner of the {@link MeshItem} object in the format [x, y]. Does not include stroke weight.
