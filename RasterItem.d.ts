/**
 * A bitmap art item in a document. A script can create a raster item from an external file, or by copying an existing item with the {@link RasterItem#duplicate} method.
 *
 * @since CS2
 * @version CS2
 *
