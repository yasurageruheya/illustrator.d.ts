...
declare class PathItems
{
	...
	/**
	 * Creates a new pathItem in the shape of an ellipse using the supplied parameters. Defaults: <b>top: 100 pt.; left: 100 pt.; width: 50 pt.; height: 100 pt.; reversed: false</b>
	...
	/**
	 * Creates a new pathItem in the shape of an polygon using the supplied parameters. Defaults: <b>centerX: 200 pt.; centerY: 300 pt.; radius: 50 pt.; sides: 8; reversed: false</b>
	...
	/**
	 * Creates a new pathItem in the shape of a rectangle with rounded corners using the supplied parameters. Defaults: <b>horizontalRadius: 15 pt.; verticalRadius: 20 pt.; reversed: false</b>
	 * @param {Number} top {@link Number} double
	 * @param {Number} left {@link Number} double
	 * @param {Number} width {@link Number} double
	 * @param {Number} height {@link Number} double
	...
	/**
	 * Creates a new path item in the shape of a star using the supplied parameters. Defaults: <b>centerX: 200 pt.; centerY: 300 pt.; radius: 50 pt.; innerRadius: 20 pt.; points: 5; reversed: false</b>
	 * @param {Number} [centerX=200] {@link Number} double
	 * @param {Number} [centerY=300] {@link Number} double
	 * @param {Number} [radius=50] {@link Number} double
