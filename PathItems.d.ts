...
declare class PathItems
{
	...
	/**
	 * Creates a new {@link PathItem} in the shape of an {@link PathItems#ellipse} using the supplied parameters. Defaults: top: 100 pt. ; left: 100 pt. ; width: 50 pt. ; height: 100 pt. ; reversed: <b>false</b>
	...
	/**
	 * Creates a new {@link PathItem} in the shape of an {@link PathItems#polygon} using the supplied parameters. Defaults: centerX: 200 pt. ; centerY: 300 pt. ; radius: 50 pt. ; sides: 8; reversed: <b>false</b>
	...
	/**
	 * Creates a new {@link PathItem} in the shape of an {@link PathItems#polygon} using the supplied parameters.
	...
	/**
	 * Creates a new {@link PathItem} in the shape of a {@link PathItems#rectangle} with rounded corners using the supplied parameters. Defaults: horizontalRadius: 15 pt. ; verticalRadius: 20 pt. ; reversed: <b>false</b>
	 * @param {Number} top {@link Number} double
	 * @param {Number} left {@link Number} double
	 * @param {Number} width {@link Number} double
	 * @param {Number} height {@link Number} double
	...
	/**
	 * Creates a new path item in the shape of a {@link PathItems#star} using the supplied parameters. Defaults: centerX: 200 pt. ; centerY: 300 pt. ; radius: 50 pt. ; innerRadius: 20 pt. ; points: 5; reversed: <b>false</b>
	 * @param {Number} [centerX=200] {@link Number} double
	 * @param {Number} [centerY=300] {@link Number} double
	 * @param {Number} [radius=50] {@link Number} double
